# CLAUDE.md — Salomão, Agente Especialista no Setor Elétrico Brasileiro (SEB)
...
tools/
  consulta_tarifas_aneel/          — CLI + app web (Streamlit) para consultar ao vivo a API de Dados Abertos da ANEEL
                                      (TE/TUSD por distribuidora/subgrupo/modalidade/REH). Construído via Claude Code
  ...
  bbce_curva_forward/              — CLI + app web (Streamlit) para consultar a BBCE Curva Forward (preços futuros de
                                      ...
                                      .env.example e README.md na pasta. Construído via Claude Code em 15/07/2026.
  consulta_pld_ccee/               — CLI + app web (Streamlit) para consultar a API de Dados Abertos da CCEE, família de
                                      ...
                                      Claude Code em 15/07/2026. Ver README.md na pasta para instruções de uso.
```
